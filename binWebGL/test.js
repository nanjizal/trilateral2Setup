...
var trilateral2Setup_ShaderTest = $hxEnums["trilateral2Setup.ShaderTest"] = { __ename__ : "trilateral2Setup.ShaderTest", __constructs__ : ["WithColor","WithTexture"]
	,WithColor: {_hx_index:0,__enum__:"trilateral2Setup.ShaderTest",toString:$estr}
	,WithTexture: {_hx_index:1,__enum__:"trilateral2Setup.ShaderTest",toString:$estr}
};
var trilateral2Setup_Main = function() {
	...
	this11[1] = 0.;
	this.cols = this11;
	var this12 = new Float32Array(trilateral2Setup_Main.largeEnough + 2);
	this12[0] = 0.;
	this12[1] = 0.;
	this.textPos = this12;
	var this13 = new Float32Array(trilateral2Setup_Main.largeEnough + 2);
	this13[0] = 0.;
	this13[1] = 0.;
	this.verts = this13;
	...
	this.shaderTest = trilateral2Setup_ShaderTest.WithColor;
	this.setupSideTrace();
...
trilateral2Setup_Main.prototype = $extend(htmlHelper_webgl_WebGLSetup.prototype,{
	...
	,loaded: function() {
		...
		var haxeLogo = js_Boot.__cast(__map_reserved["haxelogo"] != null ? _this.getReserved("haxelogo") : _this.h["haxelogo"] , Image);
	...
	,uploadVectors: function() {
		...
		var this7 = this6;
		this.verts = this7;
		var this8 = new Float32Array(1000002);
		var this9 = this8;
		this9[0] = 0.;
		this9[1] = 0.;
		var this10 = this9;
		...
		case 1:
			var gl2 = this.gl;
			var program1 = this.program;
			var vertices1 = this.vertices;
			var colors1 = this.colors;
			var name3 = htmlHelper_webgl_WebGLSetup.posName;
			var buffer3 = gl2.createBuffer();
			var arrBuffer3 = 34962;
			gl2.bindBuffer(arrBuffer3,buffer3);
			gl2.bufferData(arrBuffer3,vertices1,35044);
			var flo3 = gl2.getAttribLocation(program1,name3);
			gl2.vertexAttribPointer(flo3,3,5126,false,0,0);
			gl2.enableVertexAttribArray(flo3);
			gl2.bindBuffer(arrBuffer3,null);
			var name4 = htmlHelper_webgl_WebGLSetup.colorName;
			var buffer4 = gl2.createBuffer();
			var arrBuffer4 = 34962;
			gl2.bindBuffer(arrBuffer4,buffer4);
			gl2.bufferData(arrBuffer4,colors1,35044);
			var flo4 = gl2.getAttribLocation(program1,name4);
			gl2.vertexAttribPointer(flo4,4,5126,false,0,0);
			gl2.enableVertexAttribArray(flo4);
			gl2.bindBuffer(arrBuffer4,null);
			if(texs != null) {
				var name5 = htmlHelper_webgl_WebGLSetup.textureName;
				var buffer5 = gl2.createBuffer();
				var arrBuffer5 = 34962;
				gl2.bindBuffer(arrBuffer5,buffer5);
				gl2.bufferData(arrBuffer5,texs,35044);
				var flo5 = gl2.getAttribLocation(program1,name5);
				gl2.vertexAttribPointer(flo5,2,5126,false,0,0);
				gl2.enableVertexAttribArray(flo5);
				gl2.bindBuffer(arrBuffer5,null);
			}
			break;
		}
	}
	...
	,__class__: trilateral2Setup_Main
});
...
trilateral2Setup_drawings_DrawingLayout.prototype = {
	...
	,__class__: trilateral2Setup_drawings_DrawingLayout
};
...
trilateral2Setup_drawings_BlueRectangle.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_BlueRectangle
});
var trilateral2Setup_drawings_BorderRed = function(pen,layoutPos) {
	trilateral2Setup_drawings_DrawingLayout.call(this,pen,layoutPos);
};
trilateral2Setup_drawings_BorderRed.__name__ = true;
trilateral2Setup_drawings_BorderRed.__super__ = trilateral2Setup_drawings_DrawingLayout;
trilateral2Setup_drawings_BorderRed.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	draw: function() {
		var drawType = this.pen.drawType;
	...
	,__class__: trilateral2Setup_drawings_BorderRed
});
...
trilateral2Setup_drawings_CubicCurveTest.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_CubicCurveTest
});
...
trilateral2Setup_drawings_IndigoCircle.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_IndigoCircle
});
...
trilateral2Setup_drawings_MidGreySquareOutline.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_MidGreySquareOutline
});
...
trilateral2Setup_drawings_OrangeDavidStar.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_OrangeDavidStar
});
...
trilateral2Setup_drawings_QuadCurveTest.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_QuadCurveTest
});
...
trilateral2Setup_drawings_RedRoundedRectangleOutline.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_RedRoundedRectangleOutline
});
...
trilateral2Setup_drawings_VioletRoundedRectangle.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_VioletRoundedRectangle
});
...
trilateral2Setup_drawings_YellowDiamond.prototype = $extend(trilateral2Setup_drawings_DrawingLayout.prototype,{
	...
	,__class__: trilateral2Setup_drawings_YellowDiamond
});
...
trilateral2Setup_helpers_AxisKeys.prototype = {
	...
	,__class__: trilateral2Setup_helpers_AxisKeys
};
...
trilateral2Setup_helpers_LayoutPos.prototype = {
	__class__: trilateral2Setup_helpers_LayoutPos
};
...
trilateral2Setup_Main.largeEnough = 2000000;
